...
#REMEMBER! input data type comes as string.
...
#since computer_rps is restricive to 0,1,2 (line 46), we only do the checking for user's input.
...
if user_rps >= 3 or user_rps < 0:
    ...
    #printing computer's input as ASCII art.
